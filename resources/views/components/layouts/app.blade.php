...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <!-- Modal -->
            @php
                $modalActive = request()->is('modal-awal') || request()->is('capitals*');
            @endphp
            <li class="nav-item">
                ...
                <ul id="modal-nav" class="nav-content collapse {{ $modalActive ? 'show' : '' }}"
                    ...
                    <li>
                        <a wire:navigate class="nav-link {{ request()->is('capitals*') ? 'active' : 'collapsed' }}"
                            href="/capitals">
            ...
            <!-- Laporan -->
            @php
                $laporanActive = request()->is('laporan-*') || request()->is('profitloss');
            @endphp
            <li class="nav-item">
